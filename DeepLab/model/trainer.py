...
from model.utils_metrics import f_score
from model.callbacks import EvalCallback, LossHistory
from model.loss import Dice_loss, CE_Loss, Focal_Loss
...
def fit_one_epoch(train_model, loss_history, eval_callback, optimizer, epoch, epoch_step, epoch_step_val,
    ...
    if (epoch + 1) % args.save_period == 0 or epoch + 1 == Epoch:
        torch.save(train_model, os.path.join(save_dir, 'ep%03d-loss%.3f-val_loss%.3f-miou%.3f.pth' %
